...
# data_2 = rename(data_2, c("sdfsd"="we", wefwef))

# data_3 = rename(data_3, c("VISIT"))
```
...
library(pacman)
p_load()
data_1a= select(data_1, SUBJ, VISIT, Ethnicity, Diagnosis, Gender, Age, ADOS, MullenRaw, ExpressiveLangRaw)
