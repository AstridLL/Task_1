...
all_data$Gender = plyr::revalue(all_data$Gender, c("1"="F", "2"="M"))
...
arrange(all_data[all_data$VISIT == 6, ],all_data$tokens_CHI[all_data$VISIT == 6])

# Who produced the least amount of words on the 1st visit?
arrange(all_data[all_data$VISIT == 1, ],all_data$tokens_CHI[all_data$VISIT == 1])
