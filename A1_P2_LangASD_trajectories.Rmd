...
# loading packages
library(pacman)
p_load(plyr, dplyr, stringr, tidyverse, tidyr, ggplot2, pastecs, lmerTest)
...
# ETHNICITY
# GLM test 
ethnicity = glm(Diagnosis ~ Ethnicity, family = binomial, data)
summary(ethnicity)
# barplot
ggplot(data_1,aes(Ethnicity, Diagnosis)) +
 geom_bar(stat="summary",fun.y=mean)
